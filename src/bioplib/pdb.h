/*************************************************************************
   ...
   Copyright:  (c) SciTech Software, UCL 1993-8
...
#define STRUCTURE_TYPE_XTAL    0
#define STRUCTURE_TYPE_NMR     1
#define STRUCTURE_TYPE_MODEL   2
#define STRUCTURE_TYPE_UNKNOWN 3
