...
MIRRORDIR=/home/bsm/martin/sg2/data/kabat
# The directory where we will keep the new processed data.
NEWKABAT=/home/bsm/martin/sg2/newkabat
...
MIRRORBIN=/home/bsm/martin/mirror
...
/home/bsm/martin/kabat/src/kabatman -f >kabatman.log <<EOF
quit
EOF
echo "done"
